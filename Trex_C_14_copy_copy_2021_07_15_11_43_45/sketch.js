...
var grupodeobstaculos, obstaculo1, obstaculo2, obstaculo3, obstaculo4, obstaculo5, obstaculo6, obs;
...
function setup() {
  ...
  fim = createSprite(displayWidth / 2,displayHeight-400);
  fim.addImage(obs);
  fim.visible = false
